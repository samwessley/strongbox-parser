    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "                \n",
                "                # Handle new columns (with fallback if columns don't exist)\n",
                "                if 'Transaction Type' in df_copy.columns:\n",
                "                    df_copy['Transaction Type'] = df_copy['Transaction Type'].fillna('')\n",
                "                else:\n",
                "                    df_copy['Transaction Type'] = ''\n",
                "                    self.print_and_log(f'Warning: Transaction Type column not found in {sheet_name}, using empty values')\n",
                "                \n",
                "                if 'Relationship Name' in df_copy.columns:\n",
                "                    df_copy['Relationship Name'] = df_copy['Relationship Name'].fillna('')\n",
                "                else:\n",
                "                    df_copy['Relationship Name'] = ''\n",
                "                    self.print_and_log(f'Warning: Relationship Name column not found in {sheet_name}, using empty values')\n",
                "                \n",
                ...
                "                \n",
                "                # Create the required columns with exact names and new column positions\n",
                ...
                "        \n",
                "        # Set column widths for journal entries (updated for 9 columns)\n",
                "        je_sheet.column_dimensions['A'].width = 14.3  # Journal ID\n",
                "        je_sheet.column_dimensions['B'].width = 15.0  # Type\n",
                "        je_sheet.column_dimensions['C'].width = 48.6  # Journal Entry Description\n",
                "        je_sheet.column_dimensions['D'].width = 15.7  # Posted Date\n",
                "        je_sheet.column_dimensions['E'].width = 20.0  # Account ID\n",
                "        je_sheet.column_dimensions['F'].width = 35.7  # Journal Line Description\n",
                "        je_sheet.column_dimensions['G'].width = 25.0  # Name\n",
                "        je_sheet.column_dimensions['H'].width = 15.7  # Debit Amount\n",
                "        je_sheet.column_dimensions['I'].width = 15.7  # Credit Amount\n",
                "        \n",
                "        # Write journal entries headers with Required/Optional row (updated for new columns)\n",
                ...
                "        \n",
                "        # Style headers (updated column positions)\n",
                "        required_cols = [1, 4, 5, 8, 9]  # Columns A, D, E, H, I (Journal ID, Posted Date, Account ID, Debit, Credit)\n",
                "        optional_cols = [2, 3, 6, 7]     # Columns B, C, F, G (Type, Description, Line Description, Name)\n",
                "        \n",
                ...
                "            cell.alignment = center_alignment\n",
                "        \n",
                "        # Style column name headers (updated for 9 columns)\n",
                ...
                "                # Apply date formatting to Posted Date column (now column D)\n",
                "                if col_idx == 4:  # Posted Date column (was 3, now 4)\n",
